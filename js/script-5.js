...
// ключ свойства всегда строка запомните это

// свойства разделяються запятой
    // два одинаковых свтойства быть не может по этому значение будет с = 20 то которое ниже. Имена ключей уникальные
    // состоит обьект из ключа и значения или свойства и значения
...
/*
* Третий случай - это когда вы что-то возвращаете из функции.
*/
// Возврат - это тоже самое присвоение
...
// console.log(playlist1[propertyName])
...
* Пример 1
*/
// При присваение по ссылке в переменную b пишется указатель на то место в памяти где лежит обьект
...
* Задача 1
*/
// Сейчас будем искать друга по имени
...
* Задача 4
*/
// Получить всех друзей которые офлайн
...
* Задача 5
*/
// Нужно получить друзей по статусу онлайн
...
* Задача 6
*/
// Как мне узнать количества свойств в этом обьекте?
